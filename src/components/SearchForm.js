        ...
        <React.Fragment>
            ...
            <Offcanvas show={show} onHide={handleClose} placement="top" scroll>
                ...
                <Offcanvas.Body className='pt-0 mt-0' >
                    <Form className='mx-2 my-0 px-1 pt-1 pb-0'>
                        <Form.Group as={Row} className="mb-3" controlId="validationCustom01">
                            <Form.Label column className='fs-6' >Select Date</Form.Label>
                            <Col sm={10}>
                                <Form.Control size="sm" required type="date" placeholder="click" name="date" value={formState.date} onChange={updateFormField} />
                            </Col>
                        </Form.Group>
                    ...
                    <Button variant="primary" type="submit" className="m-0 p-1" onClick={submitForm}>
                        Search
                    </Button>
                </Offcanvas.Body>
            </Offcanvas>
